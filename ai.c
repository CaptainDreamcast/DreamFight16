...
static struct {
	List mHandledPlayers; // contains Player AI
...
static void setRandomPlayerCommandActive(PlayerAI* e) {
	...
	setPlayerCommandActiveForAI(e->mPlayer->mCommandID, name, 2);
}
...
static void updateSingleAI(void* tCaller, void* tData) {
	...
	setPlayerCommandActiveForAI(e->mPlayer->mCommandID, "holdfwd", 2);
