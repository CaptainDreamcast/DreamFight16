...
} MugenStateControllerType;

typedef struct {
	MugenAssignment* mAssignment;

} MugenStateControllerTrigger;

typedef struct {
	MugenStateControllerType mType;
	MugenStateControllerTrigger mTrigger;
...
} MugenConstantsMovementData;

typedef struct {
	char mVictory[101][1024];
} MugenConstantsQuoteData;
...
typedef struct {
	...
	int mIsAddingPower;
	MugenAssignment* mPowerAdd;

	int mDoesRequireJuggle;
	MugenAssignment* mJuggleRequired;
	...
	MugenAssignment* mDoesFacePlayer2;
...
typedef struct {
	MugenConstantsHeader mHeader;
	MugenConstantsSizeData mSizeData;
	MugenConstantsVelocityData mVelocityData;
	MugenConstantsMovementData mMovementData;
